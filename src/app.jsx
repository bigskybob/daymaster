// ─── DAYMASTER v2 — src/app.jsx (Phase 2 module port of #53) ──────────────────
// Canonical app, bundled by Vite. Pure logic is imported from ./lib (the same
// modules the unit tests cover); UI/tiles/App remain here for now and get split
// into per-tile files in a later Phase 2 pass. The repo-root app.js stays as the
// FROZEN live build until the GitHub Pages cutover — make new changes here.
...
import { TILE_EVENTS, evaluateRule, currentSlotKey, deriveCheckinSlot, checkinScheduleMin, checkinIsDone } from "./lib/rules.js";
